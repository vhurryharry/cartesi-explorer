...
import type {
  ...
  StakingPoolFactoryImplInterface,
} from "../StakingPoolFactoryImpl";
...
export class StakingPoolFactoryImpl__factory {
  static readonly abi = _abi;
  static createInterface(): StakingPoolFactoryImplInterface {
    return new Interface(_abi) as StakingPoolFactoryImplInterface;
  }
  static connect(
    address: string,
